...
from utils import CTCLabelConverter, get_config
...
def get_recognizer(model_path, config_path, 
                   separator_list={}, device = 'cpu', quantize = True):
    ...
    model = Model(opt=opt, num_class=num_class)
...
if __name__ == "__main__":
    recognizer, converter = get_recognizer('weights/TPS-ResNet-BiLSTM-CTC.pth', 'model.yaml')